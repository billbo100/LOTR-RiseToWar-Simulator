...
cols=[ 'Rarity','Name','CommanderMight','CommanderFocus', 'CommanderSpeed','Attack(ALL)', 
       ...
       'Attack(Uruk-Hai)', 'Chest', 'Defense(ALL)', 'Defense(Beasts)',
       ...
       'Defense(Uruk-Hai)', 'Dwarves', 'Elves', 'Ents',
       ...
       'HP(Trolls)', 'HP(Undead)', 'HP(Uruk-Hai)', 'Hobbits',
       ...
       'Speed(ALL)', 'Speed(Beasts)', 'Speed(Dwarves)',
       ...
       'Speed(Undead)', 'Speed(Uruk-Hai)', 'Undead',
       'Uruk-Hai']
